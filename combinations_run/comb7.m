...
for i=1:nreactions
 AA{13,i}=kron(AA{13,i},kron(AA{14,i},kron(AA{15,i},kron(AA{16,i},AA{17,i}))));
    ...
    AA{1,i}=kron(AA{1,i},AA{2,i});
    AA{3,i}=kron(AA{3,i},AA{4,i});
end
...
initial{1}=kron(initial{1},initial{2});
initial{3}=kron(initial{3},initial{4});
AA([2,4,9,10,11,14,15,16,17],:)=[];
initial([2,4,9,10,11,14,15,16,17])=[];
%%%%%%%%
