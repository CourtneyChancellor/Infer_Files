...
for i=1:nreactions
 AA{13,i}=kron(AA{13,i},kron(AA{14,i},kron(AA{15,i},kron(AA{16,i},AA{17,i}))));
    ...
    AA{5,i}=kron(AA{5,i},kron(AA{6,i},AA{7,i}));
end
...
initial{5}=kron(initial{5},kron(initial{6},initial{7}));
AA([2,3,4,6,7,9,10,11,14,15,16,17],:)=[];
initial([2,3,4,6,7,9,10,11,14,15,16,17])=[];
%%%%%%%%
